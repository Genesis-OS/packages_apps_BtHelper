            ...
            switch (extra) {
              case Constants.EXTRA_ONEPOD_CHANGED:
                handleSwitchBroadcast(
                    mOnePodModePref, intent.getBooleanExtra(Slice.EXTRA_TOGGLE_STATE, false));
                return;
              case Constants.EXTRA_AUTO_PLAY_CHANGED:
                handleSwitchBroadcast(
                    mAutoPlayPref, intent.getBooleanExtra(Slice.EXTRA_TOGGLE_STATE, false));
                return;
              case Constants.EXTRA_AUTO_PAUSE_CHANGED:
                handleSwitchBroadcast(
                    mAutoPausePref, intent.getBooleanExtra(Slice.EXTRA_TOGGLE_STATE, false));
                return;
  ...
  public boolean onPreferenceChange(Preference preference, Object newValue) {
    switch (preference.getKey()) {
      case Constants.KEY_ONEPOD_MODE:
        sendSwitchBroadcast(
            Constants.ACTION_PENDING_INTENT, Constants.EXTRA_ONEPOD_CHANGED, (boolean) newValue);
        break;
      case Constants.KEY_AUTO_PLAY:
        sendSwitchBroadcast(
            Constants.ACTION_PENDING_INTENT, Constants.EXTRA_AUTO_PLAY_CHANGED, (boolean) newValue);
        break;
